...
class simplecart_paypal
{
    ...
    public function __construct(modX &$modx, array $config=array()) {
        ...
        $basePath = $this->modx->getOption('simplecart_paypal.core_path', $config, $this->modx->getOption('core_path').'components/simplecart_paypal/');
		$assetsPath = $this->modx->getOption('simplecart_paypal.assets_path', $config, $this->modx->getOption('assets_path').'components/simplecart_paypal/');
        $assetsUrl = $this->modx->getOption('simplecart_paypal.assets_url', $config, $this->modx->getOption('assets_url').'components/simplecart_paypal/');
